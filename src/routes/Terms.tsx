  ...
  return (
    <div className="p-4 dark:text-white">
      ...
      <ul className="list-disc pl-8 mb-4">
        ...
        <li className="mb-2">
          <p>
            <strong className="font-bold">Country</strong> refers to: Israel
          </p>
        </li>
        <li className="mb-2">
          <p>
        ...
        <li className="mb-2">
          <p>
            <strong className="font-bold">Terms and Conditions</strong> (also
        ...
        <li className="mb-2">
          <p>
            <strong className="font-bold">Website</strong> refers to Scientific
            News, accessible from{" "}
            <a
      ...
      <h3 className="text-xl font-bold mb-1">Severability</h3>
      <p className="mb-4">
      ...
      <h3 className="text-xl font-bold mb-1">Waiver</h3>
      <p className="mb-4">
      ...
      <ul className="list-disc ml-8 mb-4">
        <li>
          <span className="font-bold">By email:</span> robertmof9@gmail.com
        </li>
      </ul>
    </div>
  );
